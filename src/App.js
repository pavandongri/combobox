...
/* ===============     Some Extra Features which I have added     =============================
  ...
  3) Each time instead of fetching more data, I fetched only 10 records from the api, this increases the performance

  4) When user enters search-word, instead of calling the apis immediately 
